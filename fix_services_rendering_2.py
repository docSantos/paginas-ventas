...
content = re.sub(
    r'<div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">\s*<h3 className="text-lg font-bold text-gray-900 border-b pb-2">Fotos de la Casa</h3>',
    servicios_box,
    content
)
