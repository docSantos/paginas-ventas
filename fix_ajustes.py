...
with open('src/components/casasgaby/admin/AjustesClient.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('src/components/casasgaby/admin/AjustesClient.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
